...
public class PlayerMove : MonoBehaviour {
	...
	void Update() {
		...
		if (this.CurrentPlayerState != PlayerState.WIN 
		    && this.CurrentPlayerState != PlayerState.DEATH)
		{
		    ...
		    && this.CurrentPlayerState != PlayerState.DEATH)
		{
			if (Input.GetButtonUp("Submit")
			    || Input.GetButtonUp("ActionButton")
			    || Input.GetButtonUp("Jump")
			    || Input.GetButtonUp("NextItem")
			    || Input.GetButtonUp("PreviousItem"))
			{
			...
			if (Input.GetButtonUp("NextItem"))		{ TimeManager.Instance.NextTime();		}
			if (Input.GetButtonUp("PreviousItem")) 	{ TimeManager.Instance.PreviousTime();	}
        ...
        if (Input.GetButtonUp("Reset"))  {Reset(); }
